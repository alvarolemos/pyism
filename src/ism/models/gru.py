...
class IncrementalGRUClassifier(IncrementalRecurrentClassifier):
    """Incremental GRU classifier with scikit-flow API and based on Tensorflow/Keras API.
    ...
    Examples:
        >>> from ism.models import IncrementalGRUClassifier
