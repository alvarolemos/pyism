...
class IncrementalSimpleRNNClassifier(IncrementalRecurrentClassifier):
    ...
    Examples:
        >>> from ism.models import IncrementalSimpleRNNClassifier
        ...
        >>> BATCH_SIZE = 100
        >>> 
        >>> irnn = IncrementalSimpleRNNClassifier(
        ...     n_classes=2,
        ...     n_features=2,
